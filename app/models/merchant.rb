...
#  defer_sett_amt     :integer
#  cur_bal_amt        :integer
#  business_cat       :string(255)
#  type_of_goods_sold :string(255)
...
class Merchant < ApplicationRecord
  ...
  validates :client_id, presence: true, unless: :skip_owner_presence_validation 
  ...
  DISCOUNTED_COLUMNS = %w(id created_at updated_at client_id member_id address)
